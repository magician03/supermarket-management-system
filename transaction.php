    ...
    <div class="rcontent">
        ...
        <span id="transalert"></span>
            <form action="sell.php" method="post">
                ...
                <tr><td><button class="waves-effect waves-light btn" type="submit" name="submit" onclick="validate()" value="Pay & Print"/>Pay & Print</form></td><td>
                <form action="transaction.php" method="post"><button class="waves-effect waves-light btn" type="submit" value="cancel" name="cancel"/>cancel</form></td></tr>       
                </table>                      
